...
| Start Date | End date | Total Prize Pool |
| --- | --- | --- |
| 21st of November, 2024| 10th of January, 2025 | $6,000 |
...
| Start Date | End date | Discord | Prize pool |
| --- | --- | --- | --- |
| 3rd of December | **17th of December** | [`#quest-023`](https://discord.gg/quira) | $5,000 |
...
3. Submit your repo to the Quest
4. The Quira team will review your project and if the prize pool hasn’t been depleted, we'll send you an email within 24 hours to confirm if the submission is valid. If it’s valid, we’ll send you instructions on how you can merge your sample repo into Daytona so you can claim the loot!
...
| Start Date | End date | Discord | Prize pool |
| --- | --- | --- | --- |
| 27th of November | 10th of January | [`#quest-023`](https://discord.gg/quira) | $1,000 |
