...
3. Make sure your project has a [`devcontainer.json`](https://www.daytona.io/docs/usage/builders/#dev-container). You can generate one [with AI](https://devcontainer.ai/).
